...
Gem::Specification.new do |spec|
  spec.name          = "dragonpay_rails"
  spec.version       = DragonpayRails::VERSION
  spec.authors       = ["Arman Gian Argamosa"]
  spec.email         = ["argamosa.gian@gmail.com"]

  spec.summary       = "API integration for processing dragonpay payment."
  spec.description   = "Process your payment through Dragonpay API"
  spec.homepage      = "https://github.com/gianargamosa/dragonpay"
  spec.license       = "MIT"
